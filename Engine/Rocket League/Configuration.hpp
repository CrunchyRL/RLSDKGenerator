...
private: // Call Function
	...
	static int32_t m_cfIndex;
	static std::string m_cfMask;
	static std::pair<uint8_t*, std::string> m_cfPattern;

public:
	static bool UsingCallFunctionIndex();
	static int32_t GetCallFunctionIndex();
	static uint8_t* GetCallFunctionPattern();
	static const std::string& GetCallFunctionStr();
	static const std::string& GetCallFunctionMask();
private: // Process Event
	static bool m_usePeIndex;
