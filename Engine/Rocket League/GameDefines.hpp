...
public:
	struct FPointer VfTableObject;				REGISTER_MEMBER(struct FPointer, VfTableObject, EMemberTypes::UObject_VfTable)		// 0x0000 (0x04)
		struct FPointer HashNext;				REGISTER_MEMBER(struct FPointer, HashNext, EMemberTypes::UObject_HashNext)			// 0x0010 (0x04)
		uint64_t ObjectFlags;					REGISTER_MEMBER(uint64_t, ObjectFlags, EMemberTypes::UObject_ObjectFlags)			// 0x0008 (0x08)
		struct FPointer HashOuterNext;			REGISTER_MEMBER(struct FPointer, HashOuterNext, EMemberTypes::UObject_HashOuterNext)	// 0x0014 (0x04)
		struct FPointer StateFrame;				REGISTER_MEMBER(struct FPointer, StateFrame, EMemberTypes::UObject_StateFrame)		// 0x0018 (0x04)
		class UObject* Linker;					REGISTER_MEMBER(class UObject*, Linker, EMemberTypes::UObject_Linker)				// 0x001C (0x04)
		struct FPointer LinkerIndex;			REGISTER_MEMBER(struct FPointer, LinkerIndex, EMemberTypes::UObject_LinkerIndex)		// 0x0020 (0x04)
		int32_t ObjectInternalInteger;			REGISTER_MEMBER(int32_t, ObjectInternalInteger, EMemberTypes::UObject_Integer)		// 0x0004 (0x04)
		int32_t NetIndex;						REGISTER_MEMBER(int32_t, NetIndex, EMemberTypes::UObject_NetIndex)					// 0x0024 (0x04)
		...
		class UObject* ObjectArchetype;			REGISTER_MEMBER(class UObject*, ObjectArchetype, EMemberTypes::UObject_Archetype)	// 0x0034 (0x04)
...
public:
	...
	uint64_t      UniqueFeatureValue;       REGISTER_MEMBER(uint64_t, UniqueFeatureValue, EMemberTypes::UField_UniqueFeatureValue)
public:
	static class UClass* StaticClass()
	{
		static class UClass* uClassPointer = nullptr;
...
public:
	int32_t ArraySize;						REGISTER_MEMBER(int32_t, ArraySize, EMemberTypes::UProperty_ArrayDim)						// 0x003C (0x04)
	int32_t PropertySize;					REGISTER_MEMBER(int32_t, PropertySize, EMemberTypes::UProperty_PropertySize)					// 0x0040 (0x04)
	uint64_t PropertyFlags;					REGISTER_MEMBER(uint64_t, PropertyFlags, EMemberTypes::UProperty_PropertyFlags)				// 0x0044 (0x08)
	uint16_t RepOffset;					    REGISTER_MEMBER(uint16_t, RepOffset, EMemberTypes::UProperty_RepOffset)
	uint16_t RepIndex;                      REGISTER_MEMBER(uint16_t, RepIndex, EMemberTypes::UProperty_RepIndex)
	struct FName Category;                  REGISTER_MEMBER(FName, Category, EMemberTypes::UProperty_Category)
	class UEnum* ArraySizeEnum;             REGISTER_MEMBER(UEnum*, ArraySizeEnum, EMemberTypes::UProperty_ArraySizeEnum)
	uint32_t Offset;                        REGISTER_MEMBER(uint32_t, Offset, EMemberTypes::UProperty_Offset)
	class UProperty* PropertyLinkNext;      REGISTER_MEMBER(UProperty*, PropertyLinkNext, EMemberTypes::UProperty_PropertyLinkNext)
	class UProperty* ConstructorLinkNext;   REGISTER_MEMBER(UProperty*, ConstructorLinkNext, EMemberTypes::UProperty_ConstructorLinkNext)
	class UProperty* NextRef;               REGISTER_MEMBER(UProperty*, NextRef, EMemberTypes::UProperty_NextRef)
	class FString Alias;                    REGISTER_MEMBER(FString, Alias, EMemberTypes::UProperty_Alias)
...
public:
	uint64_t FunctionFlags;					REGISTER_MEMBER(uint64_t, FunctionFlags, EMemberTypes::UFunction_Flags)				// 0x0080 (0x08)
		...
		uint16_t RepOffset;						REGISTER_MEMBER(uint16_t, RepOffset, EMemberTypes::UFunction_RepOffset)				// 0x008A (0x02)
		struct FName FriendlyName;				REGISTER_MEMBER(struct FName, FriendlyName, EMemberTypes::UFunction_FriendlyName)	// 0x013C (0x08)
		...
		unsigned long ReturnValueOffset;			REGISTER_MEMBER(unsigned long, ReturnValueOffset, EMemberTypes::UFunction_ReturnValueOffset)	// 0x0148 (0x04)
		uint8_t UnknownData00[0xC];				// 0x014C (0x12)
	FPointer Func;							REGISTER_MEMBER(FPointer, Func, EMemberTypes::UFunction_Func)						// 0x0158 (0x08)
...
{
public:
	class UFunction* SuccessCallback;		REGISTER_MEMBER(UFunction*, SuccessCallback, EMemberTypes::UDelegateProperty_SuccessCallback)    // 0x006C (0x04)
	class UFunction* FailureCallback;		REGISTER_MEMBER(UFunction*, FailureCallback, EMemberTypes::UDelegateProperty_FailureCallback)  // 0x0070 (0x04)
...
{
public:
	uint32_t ClassFlags;						REGISTER_MEMBER(uint32_t, ClassFlags, EMemberTypes::UClass_ClassFlags)						// 0x00C8 (0x04)
	uint32_t ClassUnique;						REGISTER_MEMBER(uint32_t, ClassUnique, EMemberTypes::UClass_ClassUnique)
	char ClassDelegates[80];                    REGISTER_MEMBER(ClassDelegates, ClassDelegates, EMemberTypes::UClass_ClassDelegates)
	uint32_t ClassCastFlags;					REGISTER_MEMBER(uint32_t, ClassCastFlags, EMemberTypes::UClass_ClassCastFlags)
	UClass* ClassWithin;						REGISTER_MEMBER(UClass*, ClassWithin, EMemberTypes::UClass_ClassWithin)
	FName Category;								REGISTER_MEMBER(FName, Category, EMemberTypes::UClass_Category)
	TArray<FRepRecord> ClassReps;				REGISTER_MEMBER(TArray<FRepRecord>, ClassReps, EMemberTypes::UClass_ClassReps)
	TArray<UField*> NetFields;					REGISTER_MEMBER(TArray<UField*>, NetFields, EMemberTypes::UClass_NetFields)
	TArray<FName> HideCategories;				REGISTER_MEMBER(TArray<FName>, HideCategories, EMemberTypes::UClass_HideCategories)
	TArray<FName> AutoExpandCategories;			REGISTER_MEMBER(TArray<FName>, AutoExpandCategories, EMemberTypes::UClass_AutoExpandCategories)
	TArray<FName> AutoCollapseCategories;		REGISTER_MEMBER(TArray<FName>, AutoCollapseCategories, EMemberTypes::UClass_AutoCollapseCategories)
	TArray<FName> DontSortCategories;			REGISTER_MEMBER(TArray<FName>, DontSortCategories, EMemberTypes::UClass_DontSortCategories)
	TArray<FName> DependentOn;					REGISTER_MEMBER(TArray<FName>, DependentOn, EMemberTypes::UClass_DependentOn)
	TArray<FName> ClassGroupNames;				REGISTER_MEMBER(TArray<FName>, ClassGroupNames, EMemberTypes::UClass_ClassGroupNames)
	uint32_t bForceScriptOrder;					REGISTER_MEMBER(uint32_t, bForceScriptOrder, EMemberTypes::UClass_bForceScriptOrder)
	FString ClassHeaderFilename;				REGISTER_MEMBER(FString, ClassHeaderFilename, EMemberTypes::UClass_ClassHeaderFilename)
	uint8_t ManualPad[40];					    REGISTER_MEMBER(ManualPad, ManualPad, EMemberTypes::UClass_ManualPad)
	UObject* ClassDefaultObject;				REGISTER_MEMBER(UObject*, ClassDefaultObject, EMemberTypes::UClass_ClassDefaultObject)
	void* ClassConstructor;					    REGISTER_MEMBER(void*, ClassConstructor, EMemberTypes::UClass_ClassConstructor)
	void* ClassStaticConstructor;				REGISTER_MEMBER(void*, ClassStaticConstructor, EMemberTypes::UClass_ClassStaticConstructor)
	void* ClassStaticInitializer;				REGISTER_MEMBER(void*, ClassStaticInitializer, EMemberTypes::UClass_ClassStaticInitializer)
	char ComponentNameToDefaultObjectMap[80];   REGISTER_MEMBER(ComponentNameToDefaultObjectMap, ComponentNameToDefaultObjectMap, EMemberTypes::UClass_ComponentNameToDefaultObjectMap)
	TArray<FImplementedInterface> Interfaces;	REGISTER_MEMBER(TArray<FImplementedInterface>, Interfaces, EMemberTypes::UClass_Interfaces)
	FString DefaultPropText;					REGISTER_MEMBER(FString, DefaultPropText, EMemberTypes::UClass_DefaultPropText)
	uint32_t bNeedsPropertiesLinked;			REGISTER_MEMBER(uint32_t, bNeedsPropertiesLinked, EMemberTypes::UClass_bNeedsPropertiesLinked)
	TArray<uint32_t> ReferenceTokenStream;	    REGISTER_MEMBER(TArray<uint32_t>, ReferenceTokenStream, EMemberTypes::UClass_ReferenceTokenStream)
	char ClassStates[80];                       REGISTER_MEMBER(ClassStates, ClassStates, EMemberTypes::UClass_ClassStates)
...
{
public:
	uint64_t BitMask;						REGISTER_MEMBER(uint64_t, BitMask, EMemberTypes::UBoolProperty_BitMask)					// 0x006C (0x04)
